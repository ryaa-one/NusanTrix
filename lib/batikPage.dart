...
import 'kerajinanPage.dart';
import 'kulinerPage.dart';
import 'pageSuka.dart';
import 'pageFavorit.dart';

class BatikPage extends StatefulWidget {
  const BatikPage({super.key});

  @override
  State<BatikPage> createState() => _BatikPageState();
}

class _BatikPageState extends State<BatikPage> {
  ...
  List<int> likeTotalRekomendasi = [12, 8, 6, 26];
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const KerajinanPage(),
                          ),
                        );
                      },
                ...
                child: GridView.count(
                  ...
                  children: [
                    kerajinanItem(
                      ...
                      "image/batikSidomukti.png",
                    ),
                    kerajinanItem(
                      1,
                      "Batik Buketan",
                      "Bali",
                      "image/batikBuketan.png",
                    ),
                    kerajinanItem(
                      2,
                      "Batik Gorga",
                      "Batak, Sumatera Utara",
                      "image/batikGorga.png",
                    ),
                    kerajinanItem(
                      3,
                      "Batik Tarakan",
                      "Tarakan, Kalimantan Utara",
                      "image/batikTarakan.png",
                    ),
                  ],
                ),
              ),
