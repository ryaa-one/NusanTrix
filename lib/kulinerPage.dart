...
class _KulinerPageState extends State<KulinerPage> {
  ...
  // like rekom
  List<bool> likedRekomendasi = List.generate(4, (index) => false);
  List<int> likeTotalRekomendasi = [12, 8, 6, 20];
                ...
                child: GridView.count(
                  ...
                  children: [
                    kerajinanItem(
                      ...
                      "Manokwari, Papua",
                      "image/ikanBakarManokwari.png",
                    ),
                    kerajinanItem(
                      1,
                      "Rujak Cingur",
                      "Surabaya, Jawa Timur",
                      "image/rujakCingur.png",
                    ),
                    kerajinanItem(
                      2,
                      "Sop Konro",
